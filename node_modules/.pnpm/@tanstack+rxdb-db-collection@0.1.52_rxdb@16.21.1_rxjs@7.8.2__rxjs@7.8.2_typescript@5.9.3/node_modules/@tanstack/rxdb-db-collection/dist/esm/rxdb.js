import { rxStorageWriteErrorToRxError, ensureNotFalsy, getFromMapOrCreate, clone, prepareQuery, lastOfArray } from "rxdb/plugins/core";
import DebugModule from "debug";
import { stripRxdbFields } from "./helper.js";
    ...
    sync: (params) => {
      ...
      function startOngoingFetch() {
        sub = rxCollection.$.subscribe((ev) => {
          const cur = stripRxdbFields(clone(ev.documentData));
          switch (ev.operation) {
            case `INSERT`:
